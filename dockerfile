...
RUN         dpkg --add-architecture i386 \
            ...
            && apt-get install -y -no-install-recommends build-essential cmake zip unzip software-properties-common fontconfig openjdk-8-jdk \
            && curl -sL https://deb.nodesource.com/setup_13.x | bash - \
            && apt-get install -y -no-install-recommends nodejs git mono-runtime make supervisor neofetch\  
